...
<body>
		...
		<table width="100%" border="0" cellspacing="0">
		  <tr>
		    ...
		    <td width="40%"class="td.tituloPagina" width="80%"><div class="tituloPagina" align="center">Agregar Empresa</div></td>
		...
		<ul class="menuEncabezado">
			...
			<li class="menuEncabezado"><a href="javascript:MostrarPreguntaEnAgregarIrManto('Desea Salir de Agregar Empresas?',1)">Dependencias</a></li> 		
			<li class="menuEncabezado"><a href="">Usuarios</a></li>          
			<li class="menuEncabezado"><a href="javascript:MostrarPreguntaEnAgregarIrManto('Desea Salir de Agregar Empresas?',2)">Personas</a></li> 		
    ...
    <br>
	  ...
	  <table>
       ...
       <div class="tituloPaginaReducido" align="center">Datos de Empresa</div>
	   	   	   
	   <tr>
       <td><b>Empresa:</b><input type="text" id="Empresa" value = "" placeholder="Ingrese el nombre de la Empresa"><br><br></td>
	   ...
	   <td><br><br>
		   <div class="w3-container">
           <a href="javascript:AgregarEmpresa(document.getElementById('Empresa').value,document.getElementById('Estado').value)" class="w3-button w3-lime w3-border w3-border-black w3-hover-white w3-round">Agregar</a>
           </div></td>
       </tr>
