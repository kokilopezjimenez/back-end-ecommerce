...
print("<body>");
		...
		print("<table width=\"100%\" border=\"0\" cellspacing=\"0\">");
		  print("<tr>");
		    ...
		    print("<td width=\"40%\"class=\"td.tituloPagina\" width=\"80%\"><div class=\"tituloPagina\" align=\"center\">Modificar y Eliminar Dependencia</div></td>");
    ...
    print("<br>");
	  ...
	  print("</table>");
       ...
       print("<div class=\"tituloPaginaReducido\" align=\"center\">Datos de Dependencia</div>");
		 ...
		 $result = pg_query($link, "select id,dependencia,estado,centrofuncional from \"dependencia\" where \"id\" = " . $IdDependencia);
         ...
         while ($row = pg_fetch_row($result)) {
           ...
           print("<td><b>Id Dependencia:</b><input type=\"text\" id=\"IdDependencia\" disabled value = \"" . $row[0] . "\"><br><br></td>");
		   print("<td></td>");
		   print("<td></td>");
		   print("<td></td>");
		   print("<td></td>");
		   ...
		   print("<tr>");
           print("<td><b>Dependencia:</b><input type=\"text\" id=\"Dependencia\" value = \"" . $row[1] . "\"><br><br></td>");
		   print("<td></td>");
		   print("<td></td>");
		   print("<td></td>");
		   print("<td></td>");
		   ...
		   print("<tr>");		   
           print("<td><b><br><br>Centro Funcional:</b>&nbsp&nbsp<input type=\"text\" name=\"CentroFuncional\" id=\"CentroFuncional\" value = \"" . $row[3] . "\" disabled></td>");
		   print("<td></td>");
		   print("<td></td>");
		   print("<td></td>");
		   print("<td></td>");
           ...
           print("<td><br><br>
		   <div class=\"w3-container\">
           <a href=\"javascript:GuardarDependencia(document.getElementById('IdDependencia').value,document.getElementById('Dependencia').value,document.getElementById('Estado').value,document.getElementById('CentroFuncional').value)\" class=\"w3-button w3-lime w3-border w3-border-black w3-hover-white w3-round\">Modificar</a>&nbsp&nbsp<a href=\"javascript:EliminarDependencia(document.getElementById('IdDependencia').value)\" class=\"w3-button w3-lime w3-border w3-border-black w3-hover-white w3-round\">Eliminar</a>
           </div>");		   
		   print("<td></td>");
		   print("<td></td>");
		   print("<td></td>");
